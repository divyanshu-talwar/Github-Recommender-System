...
for document in cursor:
	count = 1
	response = requests.get(document['followers_url'] + "?page=1&per_page=100&client_id=84690af0552c9ed4357b&client_secret=288d95782c060102e5f251cd880a386feef1d835")
	...
	while( response.ok ):
		...
		if( link is not None and count < lastPage ):
			...
			userFollower.update(result, result, upsert = True)
			break
	print(globalCounter)
	globalCounter += 1
